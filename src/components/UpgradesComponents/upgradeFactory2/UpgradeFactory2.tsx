...
export default function UpgradeFactory2({
  ...
  const [upgrade1Cost, setUpgrade1Cost] = useState(1000);
  const [upgrade1Out, setUpgrade1Out] = useState(false);
  const [upgrade2Cost, setUpgrade2Cost] = useState(2000);
  const [upgrade3Cost, setUpgrade3Cost] = useState(4000);
  const [upgrade4Cost, setUpgrade4Cost] = useState(6000);
